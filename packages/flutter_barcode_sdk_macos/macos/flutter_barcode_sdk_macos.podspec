...
Pod::Spec.new do |s|
  ...
  s.source           = { :path => '.' }
  s.source_files     = 'flutter_barcode_sdk_macos/Sources/flutter_barcode_sdk_macos/**/*'
  s.vendored_libraries = 'flutter_barcode_sdk_macos/Libraries/*.dylib'
  ...
  s.preserve_paths = 'flutter_barcode_sdk_macos/Resources'
  s.dependency 'FlutterMacOS'
  s.platform         = :osx, '12.0'
  s.pod_target_xcconfig = {
    'DEFINES_MODULE' => 'YES',
    'HEADER_SEARCH_PATHS' => '"$(PODS_TARGET_SRCROOT)/flutter_barcode_sdk_macos/Libraries"',
    'LIBRARY_SEARCH_PATHS' => '"$(PODS_TARGET_SRCROOT)/flutter_barcode_sdk_macos/Libraries"',
